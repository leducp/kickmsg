...
class Publisher:
    ...
    def allocate(self) -> AllocatedSlot | None:
        ...
        Supersedes the previous reservation: that AllocatedSlot refuses publish()
        and new memoryview() requests.  Buffers already exported from it cannot be
        revoked; writing through one after this call corrupts whichever
        reservation now holds the slot.
        """
